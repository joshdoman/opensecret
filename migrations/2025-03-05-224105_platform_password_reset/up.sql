CREATE TABLE platform_password_reset_requests (
    ...
    user_id UUID NOT NULL REFERENCES platform_users(uuid) ON DELETE CASCADE,
...
CREATE INDEX idx_platform_password_reset_requests_user_id ON platform_password_reset_requests(user_id);
